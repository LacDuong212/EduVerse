...
import SignInForm from "@/app/admin/auth/sign-in/components/SignInForm";

export default function SignInPage() {
  return <>
    <PageMetaData title="Admin-Sign-In" />
    <AuthLayout>
        ...
        <Row className="my-5">
          <Col sm={10} xl={8} className="m-auto">
            ...
            <div className="mt-4 text-center">
              <span>
                Don&apos;t have an account? <Link to="/admin/auth/sign-up">Signup here</Link>
              </span>
            </div>
          </Col>
        </Row>
