      ...
      <Container>
        <Row className="align-items-center g-5">
          ...
          <Col lg={7} xl={6} className="text-center position-relative">
            ...
            <div className="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-6">
              <div className="d-flex justify-content-between align-items-center">
                <span className="icon-md bg-pink rounded-circle">
                  <FaNodeJs className="text-white" size={24} />
                </span>
              </div>
            </div>
